...
interface PlayersTopYellowCardsTableProps {
  data: TopYellowCardsResponse[];
  columns: ColumnDef<TopYellowCardsResponse>[];
}

export function PlayersTopYellowCardsTable({
  data,
  columns,
}: PlayersTopYellowCardsTableProps) {
